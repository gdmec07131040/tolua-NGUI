...
namespace LuaFramework {
    public class Util {
        ...
        static int CheckRuntimeFile () {
            ...
            string sourceDir = AppConst.ThirdRoot + "/ToLua/Source/Generate/";
        ...
        static Dictionary<string, AssetID> mAssetIDCache = new Dictionary<string, AssetID> ();
        public static AssetID GetAssetID (string path) {
            AssetID result;
            string assetName = PathToAssetName (path);
            string bundleName = PathToBundleName (path);
            if (!mAssetIDCache.TryGetValue (bundleName, out result)) {
                result = new AssetID (assetName, bundleName);
            }
            return result;
        }
        static string PathToBundleName (string path) {
            return path.ToLower ();
        }
        static string PathToAssetName (string path) {
